...
AsanaBot = (function() {
  ...
  AsanaBot.prototype.poll = function(autocb) {
    ...
    (function(_this) {
      ...
      return function() {
        ...
        _this.modified_since = new Date((new Date(tasks[0].modified_at)).getTime() + 1000);
        (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/charles/source/asanabot/src/asanabot.iced",
  ...
  AsanaBot.prototype.getTasks = function(autocb) {
    var err, newTasks, params, task, tasks, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = autocb;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    params = {
    ...
    console.log("finding tasks for AS#" + this.projectId + " modified since: " + params.modified_since);
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
      ...
      return function() {
        ...
        if (!(typeof tasks !== "undefined" && tasks !== null ? tasks.length : void 0)) {
          autocb(null);
          return;
        }
        newTasks = (function() {
          ...
          for (_i = 0, _len = tasks.length; _i < _len; _i++) {
            task = tasks[_i];
            if ((new Date(task.created_at)) > (new Date(params.modified_since))) {
              _results.push(task);
            }
          }
          return _results;
